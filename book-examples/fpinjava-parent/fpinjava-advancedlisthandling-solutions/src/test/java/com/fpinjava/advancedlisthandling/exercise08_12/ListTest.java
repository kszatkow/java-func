...
public class ListTest {
  ...
  public void testGetAt_() throws Exception {
    ...
    assertEquals("Failure(java.lang.IllegalStateException: Indeks poza granicami)", list.getAt_(-2).toString());
    assertEquals("Success(1)", list.getAt_(0).toString());
    assertEquals("Success(11)", list.getAt_(5).toString());
    assertEquals("Failure(java.lang.IllegalStateException: Indeks poza granicami)", list.getAt_(7).toString());
    assertEquals("Failure(java.lang.IllegalStateException: Indeks poza granicami)", list.getAt_(9).toString());
  }
